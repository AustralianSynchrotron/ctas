 ...
 *                     ^
 *         detected during:
 *           instantiation of class "blitz::TinyVector<long int, 0>" at
 *                     line 273 of "./../blitz/array/resize.cc"
 *           instantiation of
 *                     "void blitz::Array<int, 1>::resizeAndPreserve(long int)"
 */
    ...
    MyIndexType length3)
{
        ...
        || (length2 != length_[2]) || (length3 != length_[3]))
    {
        ...
        if (numElements())
        {
            Range overlap0 = Range(fromStart,
                                   (minmax::min)(B.ubound(0), ubound(0)));
            Range overlap1 = Range(fromStart,
                                   (minmax::min)(B.ubound(1), ubound(1)));
            Range overlap2 = Range(fromStart,
                                   (minmax::min)(B.ubound(2), ubound(2)));
            Range overlap3 = Range(fromStart,
                                   (minmax::min)(B.ubound(3), ubound(3)));
    ...
    MyIndexType length3, MyIndexType length4)
{
        ...
        || (length4 != length_[4]))
    {
        ...
        if (numElements())
        {
            ...
            Range overlap3 = Range(fromStart,
                                   (minmax::min)(B.ubound(3), ubound(3)));
            Range overlap4 = Range(fromStart,
                                   (minmax::min)(B.ubound(4), ubound(4)));
    ...
    MyIndexType length3, MyIndexType length4, MyIndexType length5)
{
        ...
        || (length4 != length_[4]) || (length5 != length_[5]))
    {
        ...
        if (numElements())
        {
            ...
            Range overlap4 = Range(fromStart,
                                   (minmax::min)(B.ubound(4), ubound(4)));
            Range overlap5 = Range(fromStart,
                                   (minmax::min)(B.ubound(5), ubound(5)));
