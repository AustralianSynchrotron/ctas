 ...
 */
template<typename P_numtype, int N_rank>
template<int N_rank2, typename R0, class R1, typename R2, typename R3,
         typename R4, typename R5, typename R6, typename R7, class R8,
...
cout << "slice(" << setRank << ", [" << r.first(array.lbound(sourceRank))
    ...
    storage_.setAscendingFlag(
        setRank, array.isRankStoredAscending(sourceRank));
