...
// genarruops.cpp May  8 2009 16:45:14
...
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_atan2<T_numtype1,ptrdiff_t> > >
atan2(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    ...
    _bz_atan2<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
atan2(_bz_ArrayExpr<P_expr1> d1, IndexPlaceholder<N_index2> d2)
{
    ...
    _bz_atan2<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_atan2<ptrdiff_t,T_numtype2> > >
atan2(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    ...
    _bz_atan2<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
atan2(IndexPlaceholder<N_index1> d1, _bz_ArrayExpr<P_expr2> d2)
{
    ...
    _bz_atan2<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
atan2(IndexPlaceholder<N_index1> d1, IndexPlaceholder<N_index2> d2)
{
    ...
    _bz_atan2<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
atan2(IndexPlaceholder<N_index1> d1, float d2)
{
    ...
    _bz_atan2<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
atan2(IndexPlaceholder<N_index1> d1, double d2)
{
    ...
    _bz_atan2<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
atan2(IndexPlaceholder<N_index1> d1, long double d2)
{
    ...
    _bz_atan2<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
atan2(IndexPlaceholder<N_index1> d1, complex<T2> d2)
{
    ...
    _bz_atan2<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
atan2(float d1, IndexPlaceholder<N_index2> d2)
{
    ...
    _bz_atan2<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
atan2(double d1, IndexPlaceholder<N_index2> d2)
{
    ...
    _bz_atan2<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
atan2(long double d1, IndexPlaceholder<N_index2> d2)
{
    ...
    _bz_atan2<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
atan2(complex<T1> d1, IndexPlaceholder<N_index2> d2)
{
    ...
    _bz_atan2<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_copysign<T_numtype1,ptrdiff_t> > >
copysign(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_copysign<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_copysign<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_copysign<ptrdiff_t,T_numtype2> > >
copysign(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_copysign<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_copysign<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_copysign<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_copysign<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_copysign<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_copysign<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_copysign<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_copysign<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_copysign<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_copysign<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_copysign<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_drem<T_numtype1,ptrdiff_t> > >
drem(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_drem<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_drem<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_drem<ptrdiff_t,T_numtype2> > >
drem(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_drem<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_drem<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_drem<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_drem<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_drem<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_drem<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_drem<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_drem<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_drem<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_drem<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_drem<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_fmod<T_numtype1,ptrdiff_t> > >
fmod(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_fmod<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_fmod<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_fmod<ptrdiff_t,T_numtype2> > >
fmod(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_fmod<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_fmod<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_fmod<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_fmod<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_fmod<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_fmod<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_fmod<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_fmod<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_fmod<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_fmod<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_fmod<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_hypot<T_numtype1,ptrdiff_t> > >
hypot(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_hypot<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_hypot<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_hypot<ptrdiff_t,T_numtype2> > >
hypot(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_hypot<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_hypot<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_hypot<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_hypot<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_hypot<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_hypot<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_hypot<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_hypot<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_hypot<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_hypot<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_hypot<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_nextafter<T_numtype1,ptrdiff_t> > >
nextafter(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_nextafter<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_nextafter<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_nextafter<ptrdiff_t,T_numtype2> > >
nextafter(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_nextafter<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_nextafter<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_nextafter<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_nextafter<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_nextafter<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_nextafter<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_nextafter<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_nextafter<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_nextafter<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_nextafter<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_nextafter<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_pow<T_numtype1,ptrdiff_t> > >
pow(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_pow<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_pow<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_pow<ptrdiff_t,T_numtype2> > >
pow(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_pow<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_pow<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_pow<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_pow<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_pow<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_pow<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_pow<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_pow<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_pow<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_pow<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_pow<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_remainder<T_numtype1,ptrdiff_t> > >
remainder(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_remainder<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_remainder<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_remainder<ptrdiff_t,T_numtype2> > >
remainder(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_remainder<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_remainder<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_remainder<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_remainder<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_remainder<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_remainder<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_remainder<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_remainder<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_remainder<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_remainder<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_remainder<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_scalb<T_numtype1,ptrdiff_t> > >
scalb(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_scalb<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_scalb<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_scalb<ptrdiff_t,T_numtype2> > >
scalb(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_scalb<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_scalb<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_scalb<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_scalb<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_scalb<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_scalb<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_scalb<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_scalb<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_scalb<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_scalb<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_scalb<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_unordered<T_numtype1,ptrdiff_t> > >
unordered(const Array<T_numtype1, N_rank1>& d1, IndexPlaceholder<N_index2> d2)
{
    return _bz_ArrayExprBinaryOp<ArrayIterator<T_numtype1, N_rank1>, IndexPlaceholder<N_index2>,
    _bz_unordered<T_numtype1,ptrdiff_t> >(d1.begin(), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExpr<P_expr1>, IndexPlaceholder<N_index2>,
    _bz_unordered<typename P_expr1::T_numtype,ptrdiff_t> >(d1, d2);
}
...
inline
_bz_ArrayExpr<_bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_unordered<ptrdiff_t,T_numtype2> > >
unordered(IndexPlaceholder<N_index1> d1, const Array<T_numtype2, N_rank2>& d2)
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, ArrayIterator<T_numtype2, N_rank2>,
    _bz_unordered<ptrdiff_t,T_numtype2> >(d1, d2.begin());
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExpr<P_expr2>,
    _bz_unordered<ptrdiff_t,typename P_expr2::T_numtype> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, IndexPlaceholder<N_index2>,
    _bz_unordered<ptrdiff_t,ptrdiff_t> >(d1, d2);
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<float>,
    _bz_unordered<ptrdiff_t,float> >(d1, _bz_ArrayExprConstant<float>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<double>,
    _bz_unordered<ptrdiff_t,double> >(d1, _bz_ArrayExprConstant<double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<long double>,
    _bz_unordered<ptrdiff_t,long double> >(d1, _bz_ArrayExprConstant<long double>(d2));
}
...
{
    return _bz_ArrayExprBinaryOp<IndexPlaceholder<N_index1>, _bz_ArrayExprConstant<complex<T2> > ,
    _bz_unordered<ptrdiff_t,complex<T2> > >(d1, _bz_ArrayExprConstant<complex<T2> > (d2));
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<float>, IndexPlaceholder<N_index2>,
    _bz_unordered<float,ptrdiff_t> >(_bz_ArrayExprConstant<float>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<double>, IndexPlaceholder<N_index2>,
    _bz_unordered<double,ptrdiff_t> >(_bz_ArrayExprConstant<double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<long double>, IndexPlaceholder<N_index2>,
    _bz_unordered<long double,ptrdiff_t> >(_bz_ArrayExprConstant<long double>(d1), d2);
}
...
{
    return _bz_ArrayExprBinaryOp<_bz_ArrayExprConstant<complex<T1> > , IndexPlaceholder<N_index2>,
    _bz_unordered<complex<T1> ,ptrdiff_t> >(_bz_ArrayExprConstant<complex<T1> > (d1), d2);
}
