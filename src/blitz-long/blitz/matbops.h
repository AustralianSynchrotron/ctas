...
// Created by: genmatbops.cpp Feb  9 2009 17:22:49
...
// Matrix<P_numtype1, P_struct1> + ptrdiff_t
template<class P_numtype1, class P_struct1>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatrixRef<P_numtype1, P_struct1>, 
      _bz_MatExprConstant<ptrdiff_t>,
      ...
      ptrdiff_t d2)
{
    ...
    return _bz_MatExpr<T_expr>(T_expr(d1._bz_getRef(), 
      _bz_MatExprConstant<ptrdiff_t>(d2)));
}
...
// ptrdiff_t + Matrix<P_numtype2, P_struct2>
template<class P_numtype2, class P_struct2>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExprConstant<ptrdiff_t>, 
      _bz_MatrixRef<P_numtype2, P_struct2>,
      _bz_Add<ptrdiff_t, P_numtype2 > > >
operator+(ptrdiff_t d1, 
      const Matrix<P_numtype2, P_struct2>& d2)
{
    typedef _bz_MatExprOp<_bz_MatExprConstant<ptrdiff_t>, 
      _bz_MatrixRef<P_numtype2, P_struct2>, 
      _bz_Add<ptrdiff_t, P_numtype2> > T_expr;

    return _bz_MatExpr<T_expr>(T_expr(_bz_MatExprConstant<ptrdiff_t>(d1), 
      d2._bz_getRef()));
}

// ptrdiff_t + _bz_MatExpr<P_expr2>
template<class P_expr2>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExprConstant<ptrdiff_t>, 
      _bz_MatExpr<P_expr2>,
...
// Matrix<P_numtype1, P_struct1> min ptrdiff_t
template<class P_numtype1, class P_struct1>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatrixRef<P_numtype1, P_struct1>, 
      _bz_MatExprConstant<ptrdiff_t>,
...
// _bz_MatExpr<P_expr1> min ptrdiff_t
template<class P_expr1>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExpr<P_expr1>, 
      _bz_MatExprConstant<ptrdiff_t>,
...
// ptrdiff_t min Matrix<P_numtype2, P_struct2>
template<class P_numtype2, class P_struct2>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExprConstant<ptrdiff_t>, 
      _bz_MatrixRef<P_numtype2, P_struct2>,
...
// ptrdiff_t min _bz_MatExpr<P_expr2>
template<class P_expr2>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExprConstant<ptrdiff_t>, 
      _bz_MatExpr<P_expr2>,
...
// Matrix<P_numtype1, P_struct1> max ptrdiff_t
template<class P_numtype1, class P_struct1>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatrixRef<P_numtype1, P_struct1>, 
      _bz_MatExprConstant<ptrdiff_t>,
...
// _bz_MatExpr<P_expr1> max ptrdiff_t
template<class P_expr1>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExpr<P_expr1>, 
      _bz_MatExprConstant<ptrdiff_t>,
...
// ptrdiff_t max Matrix<P_numtype2, P_struct2>
template<class P_numtype2, class P_struct2>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExprConstant<ptrdiff_t>, 
      _bz_MatrixRef<P_numtype2, P_struct2>,
...
// ptrdiff_t max _bz_MatExpr<P_expr2>
template<class P_expr2>
inline
_bz_MatExpr<_bz_MatExprOp<_bz_MatExprConstant<ptrdiff_t>, 
      _bz_MatExpr<P_expr2>,
