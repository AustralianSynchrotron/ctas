...
template<typename T_array, typename T_arrayiter, typename T_subdomain,
         typename T_expr>
...
inline void applyOverSubdomain(const T_array& BZ_DEBUG_PARAM(array),
                               T_arrayiter& arrayIter, 
                               RectDomain<N_rank> subdomain, T_expr expr)
{
