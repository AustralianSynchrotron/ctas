...
// genvecbfn.cpp Jun 12 2024 18:35:31
...
_bz_VecExpr<_bz_VecExprOp<VectorIterConst<P_numtype1>, 
      Range,
      _bz_Min<P_numtype1, ptrdiff_t > > >
(min)(const Vector<P_numtype1>& d1, 
      Range d2)
{
    typedef _bz_VecExprOp<VectorIterConst<P_numtype1>, 
      Range, 
      _bz_Min<P_numtype1, ptrdiff_t> > T_expr;
...
// Vector<P_numtype1> min ptrdiff_t
template<class P_numtype1>
inline
_bz_VecExpr<_bz_VecExprOp<VectorIterConst<P_numtype1>, 
      ...
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExpr<P_expr1>, 
      Range, 
      _bz_Min<typename P_expr1::T_numtype, ptrdiff_t> > T_expr;
...
// _bz_VecExpr<P_expr1> min ptrdiff_t
template<class P_expr1>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExpr<P_expr1>, 
      _bz_VecExprConstant<ptrdiff_t>,
...
// VectorPick<P_numtype1> min ptrdiff_t
template<class P_numtype1>
inline
_bz_VecExpr<_bz_VecExprOp<VectorPickIterConst<P_numtype1>, 
      _bz_VecExprConstant<ptrdiff_t>,
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      VectorIterConst<P_numtype2>,
      _bz_Min<ptrdiff_t, P_numtype2 > > >
(min)(Range d1, 
      const Vector<P_numtype2>& d2)
{
    typedef _bz_VecExprOp<Range, 
      VectorIterConst<P_numtype2>, 
      _bz_Min<ptrdiff_t, P_numtype2> > T_expr;
      ...
      _bz_VecExpr<P_expr2> d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExpr<P_expr2>, 
      _bz_Min<ptrdiff_t, typename P_expr2::T_numtype> > T_expr;
      ...
      Range d2)
{
    typedef _bz_VecExprOp<Range, 
      Range, 
      _bz_Min<ptrdiff_t, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<float>,
      _bz_Min<ptrdiff_t, float > > >
(min)(Range d1, 
      float d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<float>, 
      _bz_Min<ptrdiff_t, float> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<double>,
      _bz_Min<ptrdiff_t, double > > >
(min)(Range d1, 
      double d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<double>, 
      _bz_Min<ptrdiff_t, double> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<long double>,
      _bz_Min<ptrdiff_t, long double > > >
(min)(Range d1, 
      long double d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<long double>, 
      _bz_Min<ptrdiff_t, long double> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<complex<T2> > ,
      _bz_Min<ptrdiff_t, complex<T2>  > > >
(min)(Range d1, 
      complex<T2> d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<complex<T2> > , 
      _bz_Min<ptrdiff_t, complex<T2> > > T_expr;
...
// TinyVector<P_numtype1, N_length1> min ptrdiff_t
template<class P_numtype1, int N_length1>
inline
_bz_VecExpr<_bz_VecExprOp<TinyVectorIterConst<P_numtype1, N_length1>, 
      _bz_VecExprConstant<ptrdiff_t>,
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<float>, 
      Range,
      _bz_Min<float, ptrdiff_t > > >
(min)(float d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<float>, 
      Range, 
      _bz_Min<float, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<double>, 
      Range,
      _bz_Min<double, ptrdiff_t > > >
(min)(double d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<double>, 
      Range, 
      _bz_Min<double, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<long double>, 
      Range,
      _bz_Min<long double, ptrdiff_t > > >
(min)(long double d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<long double>, 
      Range, 
      _bz_Min<long double, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<complex<T1> > , 
      Range,
      _bz_Min<complex<T1> , ptrdiff_t > > >
(min)(complex<T1> d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<complex<T1> > , 
      Range, 
      _bz_Min<complex<T1> , ptrdiff_t> > T_expr;
...
// ptrdiff_t min Vector<P_numtype2>
template<class P_numtype2>
inline
...
// ptrdiff_t min _bz_VecExpr<P_expr2>
template<class P_expr2>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<ptrdiff_t>, 
      _bz_VecExpr<P_expr2>,
...
// ptrdiff_t min VectorPick<P_numtype2>
template<class P_numtype2>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<ptrdiff_t>, 
      VectorPickIterConst<P_numtype2>,
...
// ptrdiff_t min TinyVector<P_numtype2, N_length2>
template<class P_numtype2, int N_length2>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<ptrdiff_t>, 
      TinyVectorIterConst<P_numtype2, N_length2>,
...
_bz_VecExpr<_bz_VecExprOp<VectorIterConst<P_numtype1>, 
      Range,
      _bz_Max<P_numtype1, ptrdiff_t > > >
(max)(const Vector<P_numtype1>& d1, 
      Range d2)
{
    typedef _bz_VecExprOp<VectorIterConst<P_numtype1>, 
      Range, 
      _bz_Max<P_numtype1, ptrdiff_t> > T_expr;
...
// Vector<P_numtype1> max ptrdiff_t
template<class P_numtype1>
inline
_bz_VecExpr<_bz_VecExprOp<VectorIterConst<P_numtype1>, 
      _bz_VecExprConstant<ptrdiff_t>,
      ...
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExpr<P_expr1>, 
      Range, 
      _bz_Max<typename P_expr1::T_numtype, ptrdiff_t> > T_expr;
...
// _bz_VecExpr<P_expr1> max ptrdiff_t
template<class P_expr1>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExpr<P_expr1>, 
      _bz_VecExprConstant<ptrdiff_t>,
...
// VectorPick<P_numtype1> max ptrdiff_t
template<class P_numtype1>
inline
_bz_VecExpr<_bz_VecExprOp<VectorPickIterConst<P_numtype1>, 
      _bz_VecExprConstant<ptrdiff_t>,
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      VectorIterConst<P_numtype2>,
      _bz_Max<ptrdiff_t, P_numtype2 > > >
(max)(Range d1, 
      const Vector<P_numtype2>& d2)
{
    typedef _bz_VecExprOp<Range, 
      VectorIterConst<P_numtype2>, 
      _bz_Max<ptrdiff_t, P_numtype2> > T_expr;
      ...
      _bz_VecExpr<P_expr2> d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExpr<P_expr2>, 
      _bz_Max<ptrdiff_t, typename P_expr2::T_numtype> > T_expr;
      ...
      Range d2)
{
    typedef _bz_VecExprOp<Range, 
      Range, 
      _bz_Max<ptrdiff_t, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<float>,
      _bz_Max<ptrdiff_t, float > > >
(max)(Range d1, 
      float d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<float>, 
      _bz_Max<ptrdiff_t, float> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<double>,
      _bz_Max<ptrdiff_t, double > > >
(max)(Range d1, 
      double d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<double>, 
      _bz_Max<ptrdiff_t, double> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<long double>,
      _bz_Max<ptrdiff_t, long double > > >
(max)(Range d1, 
      long double d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<long double>, 
      _bz_Max<ptrdiff_t, long double> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<Range, 
      _bz_VecExprConstant<complex<T2> > ,
      _bz_Max<ptrdiff_t, complex<T2>  > > >
(max)(Range d1, 
      complex<T2> d2)
{
    typedef _bz_VecExprOp<Range, 
      _bz_VecExprConstant<complex<T2> > , 
      _bz_Max<ptrdiff_t, complex<T2> > > T_expr;
...
// TinyVector<P_numtype1, N_length1> max ptrdiff_t
template<class P_numtype1, int N_length1>
inline
_bz_VecExpr<_bz_VecExprOp<TinyVectorIterConst<P_numtype1, N_length1>, 
      _bz_VecExprConstant<ptrdiff_t>,
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<float>, 
      Range,
      _bz_Max<float, ptrdiff_t > > >
(max)(float d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<float>, 
      Range, 
      _bz_Max<float, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<double>, 
      Range,
      _bz_Max<double, ptrdiff_t > > >
(max)(double d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<double>, 
      Range, 
      _bz_Max<double, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<long double>, 
      Range,
      _bz_Max<long double, ptrdiff_t > > >
(max)(long double d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<long double>, 
      Range, 
      _bz_Max<long double, ptrdiff_t> > T_expr;
...
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<complex<T1> > , 
      Range,
      _bz_Max<complex<T1> , ptrdiff_t > > >
(max)(complex<T1> d1, 
      Range d2)
{
    typedef _bz_VecExprOp<_bz_VecExprConstant<complex<T1> > , 
      Range, 
      _bz_Max<complex<T1> , ptrdiff_t> > T_expr;
...
// ptrdiff_t max Vector<P_numtype2>
template<class P_numtype2>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<ptrdiff_t>, 
      VectorIterConst<P_numtype2>,
...
// ptrdiff_t max _bz_VecExpr<P_expr2>
template<class P_expr2>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<ptrdiff_t>, 
      _bz_VecExpr<P_expr2>,
...
// ptrdiff_t max VectorPick<P_numtype2>
template<class P_numtype2>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<ptrdiff_t>, 
      VectorPickIterConst<P_numtype2>,
...
// ptrdiff_t max TinyVector<P_numtype2, N_length2>
template<class P_numtype2, int N_length2>
inline
_bz_VecExpr<_bz_VecExprOp<_bz_VecExprConstant<ptrdiff_t>, 
      TinyVectorIterConst<P_numtype2, N_length2>,
