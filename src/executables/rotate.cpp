...
struct clargs {
  ...
  Crop crop;                  ///< Crop resulting image
  bool beverbose;
  /// \CLARGSF
  ...
  out_name("<input>")
{
  ...
  ("Rotates the input image.",
   "Rotates the image by the requested angle around the center.");
  ...
  .add(poptmx::OPTION, &crop, 'c', "crop",
       CropOptionDesc, "")
  .add(poptmx::OPTION, &background, 'b', "background",
...
int main(int argc, char *argv[]) {
  ...
  rotate(arr, out, args.angle, args.crop, args.background);
