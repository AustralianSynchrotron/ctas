...
///
/// @brief Makes sinograms from the (E)DEI input contrasts.
///
...
struct clargs {
  ...
  DEIprocess::Component contrast; ///< Component to be extracted.
...
clargs(int argc, char *argv[]) : 
  ...
  contrast(DEIprocess::REF)
{

  poptmx::OptionTable table
	("Forms DEI-based sinogram(s).",
  ...
  table
	...
	.add(poptmx::OPTION, &contrast, 'C', "component",
		 ...
		 "The component of the contrast to extract via the DEI method."
...
int main(int argc, char *argv[]) {
  ...
  const DEIexp expr(proc, args.contrast, Mlist, Plist);
  int
    thetas=expr.thetas(),
    pixels=expr.pixels(),
    slices=expr.slices();
